 ...
 */
final class Version20220704131601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE messenger ADD parent_id INT DEFAULT NULL, ADD titre VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE messenger DROP parent_id, DROP titre');
    }
}
